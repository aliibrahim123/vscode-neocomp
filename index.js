...
// node_modules/typescript-template-language-service-decorator/lib/util/regexp.js
var require_regexp = __commonJS({
  "node_modules/typescript-template-language-service-decorator/lib/util/regexp.js"(exports2) {
    "use strict";
...
// node_modules/typescript-template-language-service-decorator/lib/nodes.js
var require_nodes = __commonJS({
  "node_modules/typescript-template-language-service-decorator/lib/nodes.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.isTagged = exports2.isTaggedLiteral = exports2.findAllNodes = exports2.findNode = exports2.relative = void 0;
    ...
    exports2.isTaggedLiteral = isTaggedLiteral;
    function isTagged(node, tags) {
      const text = node.tag.getText();
      return tags.some((tag) => text === tag || new RegExp(`$${(0, regexp_1.escapeRegExp)(tag)}\\s*^`).test(text) || text.startsWith(tag + ".") || text.endsWith("." + tag) || text.startsWith(tag + "(") || text.startsWith(tag + "<") || text.startsWith(tag + "["));
    }
    exports2.isTagged = isTagged;
  }
});

// node_modules/typescript-template-language-service-decorator/lib/standard-script-source-helper.js
var require_standard_script_source_helper = __commonJS({
  "node_modules/typescript-template-language-service-decorator/lib/standard-script-source-helper.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    var nodes_1 = require_nodes();
    var StandardScriptSourceHelper = class {
      ...
      getNode(fileName, position) {
        ...
        return sourceFile && (0, nodes_1.findNode)(this.typescript, sourceFile, position);
      }
      getAllNodes(fileName, cond) {
        const sourceFile = this.getSourceFile(fileName);
        return sourceFile ? (0, nodes_1.findAllNodes)(this.typescript, sourceFile, cond) : [];
      }
      ...
      getSourceFile(fileName) {
        ...
        return program ? program.getSourceFile(fileName) : void 0;
      }
    };
    exports2.default = StandardScriptSourceHelper;
  }
});

// node_modules/typescript-template-language-service-decorator/lib/template-language-service-decorator.js
var require_template_language_service_decorator = __commonJS({
  "node_modules/typescript-template-language-service-decorator/lib/template-language-service-decorator.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    var TemplateLanguageServiceProxy = class {
      ...
      decorate(languageService) {
        const intercept = /* @__PURE__ */ Object.create(null);
      ...
      tryAdaptGetSupportedCodeFixes() {
        ...
        this.wrap("getSupportedCodeFixes", (delegate) => (_fileName) => {
          return [
            ...delegate(),
      ...
      tryAdaptGetDefinitionAtPosition() {
        ...
        this.wrap("getDefinitionAtPosition", (delegate) => (fileName, position, ...rest) => {
          ...
          if (context) {
            ...
            return definition ? definition.map((def) => this.translateDefinitionInfo(context, def)) : void 0;
          }
          return delegate(fileName, position, ...rest);
        });
      }
      tryAdaptGetDefinitionAndBoundSpan() {
        ...
        this.wrap("getDefinitionAndBoundSpan", (delegate) => (fileName, position, ...rest) => {
          const context = this.sourceHelper.getTemplate(fileName, position);
          if (context) {
            const definitionAndBoundSpan = this.templateStringService.getDefinitionAndBoundSpan(context, this.sourceHelper.getRelativePosition(context, position));
      ...
      tryAdaptGetSignatureHelpItemsAtPosition() {
        ...
        this.wrap("getSignatureHelpItems", (delegate) => (fileName, position, ...rest) => {
          ...
          return signatureHelp ? this.translateSignatureHelpItems(context, signatureHelp) : void 0;
        });
      }
      ...
      translateCompletionEntry(context, entry) {
        return Object.assign(Object.assign({}, entry), { replacementSpan: entry.replacementSpan ? this.translateTextSpan(context, entry.replacementSpan) : void 0 });
      }
      ...
      translateDefinitionInfo(context, definition) {
        return Object.assign(Object.assign({}, definition), { fileName: definition.fileName || context.fileName, textSpan: this.translateTextSpan(context, definition.textSpan) });
      }
    ...
    exports2.default = TemplateLanguageServiceProxy;
  }
});

// node_modules/typescript-template-language-service-decorator/lib/util/memoize.js
var require_memoize = __commonJS({
  "node_modules/typescript-template-language-service-decorator/lib/util/memoize.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
...
// node_modules/typescript-template-language-service-decorator/lib/standard-template-source-helper.js
var require_standard_template_source_helper = __commonJS({
  "node_modules/typescript-template-language-service-decorator/lib/standard-template-source-helper.js"(exports2) {
    "use strict";
    ...
    var PlaceholderSubstituter = class _PlaceholderSubstituter {
      static replacePlaceholders(typescript, settings, node) {
        ...
        return _PlaceholderSubstituter.getSubstitutions(settings, literalContents, _PlaceholderSubstituter.getPlaceholderSpans(node));
      }
      ...
      static getSubstitution(settings, templateString, start, end) {
        return settings.getSubstitution ? settings.getSubstitution(templateString, start, end) : "x".repeat(end - start);
      }
    };
    var StandardTemplateContext = class {
    ...
    var StandardTemplateSourceHelper = class {
      ...
      getAllTemplates(fileName) {
        const out = [];
        for (const node of this.helper.getAllNodes(fileName, (n) => this.getValidTemplateNode(this.templateStringSettings, n) !== void 0)) {
    ...
    exports2.default = StandardTemplateSourceHelper;
  }
});

// node_modules/typescript-template-language-service-decorator/lib/index.js
var require_lib = __commonJS({
  "node_modules/typescript-template-language-service-decorator/lib/index.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.decorateWithTemplateLanguageService = void 0;
    var standard_script_source_helper_1 = require_standard_script_source_helper();
    var template_language_service_decorator_1 = require_template_language_service_decorator();
    var standard_template_source_helper_1 = require_standard_template_source_helper();
    var nullLogger = new class NullLogger {
      log(_msg) {
      }
    }();
    function decorateWithTemplateLanguageService2(typescript, languageService, project, templateService, templateSettings, additionalConfig) {
    ...
    exports2.decorateWithTemplateLanguageService = decorateWithTemplateLanguageService2;
  }
});

// index.ts
var import_typescript_template_language_service_decorator = __toESM(require_lib());
...
// index.ts
var htmlService = getLanguageService();
var HtmlTemplateLanguageService = class {
  ...
  getQuickInfoAtPosition(context, position) {
    ...
    if (!hover || !hover.range) return void 0;
